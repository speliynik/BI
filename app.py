...
data = {
    "Дата": pd.date_range(start="2024-07-01", end="2024-11-30", freq="D"),
    "Номенклатурная группа": ["Стрелки", "Ремкомплекты", "Крестовины"] * 153,
    "Цех": ["Механо-сборочный", "Механо-изготовительный"] * 230,
    "План": [100, 150, 200] * 153,
    "Факт": [90, 140, 190] * 153,
    "Проект": ["Проект A", "Проект B", "Проект C"] * 153,
    "Рынок": ["РЖД", "Прочий рынок"] * 230,
}
